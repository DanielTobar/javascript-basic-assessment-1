...
function doubleTheFun (parameter){
	if(isNaN(parameter)){return	parameter + parameter;}
...
function makeChatMessage(param1, param2) {
	var res = {message: param1,
		author: param2,
		 timestamp:new Date()
	 };
return res;
...
/*
    ...
    temperature > 40 and cloudiness over 60 - return "I have icecicles"
...
// #16 Create a function called callerBack that takes in a function (holla) && a string parameter(back) and invokes it(holla) with the argument string(back) + ' back'."
